...
const EmployeeForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Navigate to EmployeeDetails and pass the form data
            navigate("/details", { state: { employeeData: formattedData } });
        } catch (error) {
    ...
    return (
        <div className="container">
            ...
            <form onSubmit={handleSubmit} className="form-body">
                ...
                <button type="button" className="back-btn" onClick={handleBack}>Back to Dashboard</button>
            </form>
        </div>
    );
};
